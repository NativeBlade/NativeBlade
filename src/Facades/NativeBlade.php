 ...
 * @method static \NativeBlade\NativeResponse openAppSettings() Open the OS app-settings page (the next step after a denied permission). Works on Android (app details settings) and iOS (settings URL) via the always-on nativeblade-system plugin; no-op on desktop.
