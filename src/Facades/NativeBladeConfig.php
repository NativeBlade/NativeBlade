 ...
 * @method static static admobConfig(string $androidAppId, string $iosAppId, ?string $trackingDescription = null, array $skAdNetworkIds = []) Configure AdMob app ids and the iOS ATT / SKAdNetwork plist entries generated by `nativeblade:config`.
