---
title: "Realtime"
description: "WebSockets and pub/sub for live updates and streaming."
---
...
`import`/`export` there; see [Architecture](/core/architecture/)). The events keep the same names,
delivered on `window`:
