...
description: "Background collectors and the courier model."
---
...
> open**? That is the [Scheduler](/core/scheduler/). Background Tasks are its
...
- [Scheduler](/core/scheduler/), recurring PHP tasks while the app is open (time-based; TaskManager is reliability-based)
- [Network](/core/network/), connectivity events for in-app sync logic
