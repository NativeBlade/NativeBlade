---
title: "Analytics"
description: "Track events and screens."
---
...
- [Configuration](/configuration/overview/), `firebase()` and `analyticsConfig()` config
- [Plugins](/core/plugins/), the `NativeBlade` facade
- [Push Notifications](/mobile/push/), the other Firebase service
