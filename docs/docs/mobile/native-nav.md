...
them on Android: instead of a CSS transition, the outgoing page is snapshotted
and animated by the platform's own compositor, in the native Material style.
